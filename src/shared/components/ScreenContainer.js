...
export default function ScreenContainer({ children, scroll = true, contentStyle, showHeader = true, showFooter = true }) {
  ...
  const routeTitleMap = {
    ...
    SmartOfficeControl: 'Văn phòng thông minh',
    Home: 'Trang chủ',
    Login: 'Đăng nhập',
  };
        ...
        <View style={styles.menuRoot}>
          ...
          >
            <View style={[styles.menuHeader, { borderBottomColor: colors.border }]}> 
              <Text style={[styles.menuTitle, { color: colors.text }]}>Truy cập nhanh</Text>
            ...
            <View style={styles.menuList}>
              ...
              >
                ...
                <Text style={[styles.menuItemText, { color: colors.text }]}>Văn phòng thông minh</Text>
              </Pressable>

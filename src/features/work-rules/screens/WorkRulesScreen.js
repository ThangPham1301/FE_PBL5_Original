...
export default function WorkRulesScreen() {
  ...
  const rules = [
    'Chấm công vào đúng giờ theo ca đã được gán.',
    'Đi trễ quá ngưỡng sẽ được ghi nhận là đi trễ.',
    'Nghỉ phép cần tạo đơn và chờ phê duyệt.',
    'Chấm công ra cuối ngày để hoàn tất ngày công.',
  ];

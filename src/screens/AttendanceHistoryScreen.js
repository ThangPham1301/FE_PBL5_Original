...
import { attendanceAPI, unwrapResponse } from '../services/api';
...
export default function AttendanceHistoryScreen() {
  ...
  return (
    <ScreenContainer scroll={false}>
      <Text style={[styles.title, { color: colors.text }]}>Lịch sử chấm công</Text>
      <FlatList
        data={filteredItems}
        ...
        details={
          selectedItem
            ? [
                ...
                { label: 'Check-in', value: selectedItem.check_in || '--' },
                { label: 'Check-out', value: selectedItem.check_out || '--' },
              ]
            : []
        }
      />
